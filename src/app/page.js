...
+ also learning to be okay with not knowing everything yet and building anyway`;
          ...
          const intensities = ['rgba(255,255,255,0.05)', '#0e4429', '#006d32', '#26a641', '#39d353'];
          for(let c=0; c<52; c++) {
            for(let r=0; r<7; r++) {
