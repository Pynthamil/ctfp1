...
<div style="display: flex; gap: 20px; overflow-x: auto; padding-bottom: 15px; margin-top: 15px; scrollbar-width: none; -ms-overflow-style: none;">
  <a href="https://my-blog-tan-tau.vercel.app/posts/readme-aesthetic" target="_blank" style="text-decoration: none; color: inherit; flex: 0 0 350px;">
  ...
  <a href="https://my-blog-tan-tau.vercel.app/posts/my-first-post" target="_blank" style="text-decoration: none; color: inherit; flex: 0 0 350px;">
    <div style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 8px; border: 1px solid var(--accent-muted); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column; cursor: pointer;">
