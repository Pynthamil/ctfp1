  ...
  <blockquote style="border-left: 4px solid var(--accent); padding-left: 16px; margin: 20px 0 10px; font-style: italic; color: var(--text-muted); line-height: 1.6; font-size: 1.1em; font-family: var(--font-geist), sans-serif;">
    &ldquo;GitPrompt treats prompts not as static configuration files, but as code assets: fully versioned, testable, collaborative, and auditable pipelines.&rdquo;
          ...
          },
          {
            ...
            details: `A comprehensive design for the ACM Hackathon portal, featuring a sleek user interface for registration, submissions, and leaderboards.\n\n**Interface**\n<div style="display: flex; flex-direction: column; gap: 25px; margin-top: 15px; margin-bottom: 15px;">\n  <div><img loading="lazy" src="/hack-portal/landing-page.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /><div style="text-align: center; color: var(--text-secondary); font-size: 0.9em; margin-top: 8px; font-weight: 600;">Landing Page</div></div>\n  <div><span style="color: var(--text); display: block; margin-bottom: 6px; font-weight: 600; font-size: 1.05em;">Event Ecosystem</span><p style="margin: 0 0 12px 0; color: var(--text-muted); font-size: 0.95em; line-height: 1.5;">The concept proposes a centralized information layer designed to support hundreds of participants through real-time updates and seamless team management. The interface prioritizes high-stress usability, aiming to make critical event data immediate and accessible.</p><img loading="lazy" src="/hack-portal/hack-details.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /></div>\n  <div><img loading="lazy" src="/hack-portal/profile.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /><div style="text-align: center; color: var(--text-secondary); font-size: 0.9em; margin-top: 8px; font-weight: 600;">User Profile</div></div>\n  <div><img loading="lazy" src="/hack-portal/profile-projects.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /><div style="text-align: center; color: var(--text-secondary); font-size: 0.9em; margin-top: 8px; font-weight: 600;">Profile Projects</div></div>\n  <div><img loading="lazy" src="/hack-portal/submission.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /><div style="text-align: center; color: var(--text-secondary); font-size: 0.9em; margin-top: 8px; font-weight: 600;">Project Submission</div></div>\n</div>\n\n**Flow**\n<div style="display: flex; flex-direction: column; gap: 25px; margin-top: 15px; margin-bottom: 15px;">\n  <div><span style="color: var(--text); display: block; margin-bottom: 6px; font-weight: 600; font-size: 1.05em;">Participation Lifecycle</span><p style="margin: 0 0 12px 0; color: var(--text-muted); font-size: 0.95em; line-height: 1.5;">Designed to manage the complexity of team-based submissions. The proposed workflow imagines a friction-free transition from registration to final project tracking, intended to preserve participant mental energy for the creative work.</p><img loading="lazy" src="/hack-portal/track-submission.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /></div>\n  <div><img loading="lazy" src="/hack-portal/leaderboard.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /><div style="text-align: center; color: var(--text-secondary); font-size: 0.9em; margin-top: 8px; font-weight: 600;">Leaderboard</div></div>\n</div>\n\n**Momentum**\n<div style="display: flex; flex-direction: column; gap: 25px; margin-top: 15px; margin-bottom: 15px;">\n  <div><span style="color: var(--text); display: block; margin-bottom: 6px; font-weight: 600; font-size: 1.05em;">Hack Cafe</span><p style="margin: 0 0 12px 0; color: var(--text-muted); font-size: 0.95em; line-height: 1.5;">The concept proposes 'Hack Cafe', a digital space conceptualized for casual interaction and community building. The design aims to balance the intensity of competition with modular social layers intended to foster peer-to-peer networking.</p><img loading="lazy" src="/hack-portal/hack-cafe.svg" style="width: 100%; height: auto; border-radius: 6px; background-color: #AF2997; border: 1px solid var(--accent-muted);" /></div>\n</div>\n\n<blockquote style="border-left: 4px solid var(--accent); padding-left: 16px; margin: 30px 0 10px; font-style: italic; color: var(--text-muted); line-height: 1.6; font-size: 1.1em; font-family: var(--font-geist), sans-serif;">\n  &ldquo;This concept reimagines the traditional hackathon portal as a gamified platform that makes collaboration, event participation, and project development more engaging. By combining game-inspired progression with streamlined workflows, the experience encourages participation, reduces logistical friction, and helps teams stay motivated from registration to final submission.&rdquo;\n</blockquote>`,
            tech: [],
            link: "#"
          },
          {
